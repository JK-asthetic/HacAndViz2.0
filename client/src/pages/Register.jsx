          ...
          <CardContent>
            <div className="text-center py-12">
              ...
              <p className="text-lg mb-6 max-w-xl mx-auto">
                Thank you for your interest in Hack and Viz 2.0. The
                registration deadline has passed, and we are no longer accepting
                new participants.
              </p>

              <div className="p-4 bg-blue-50 rounded-lg border border-blue-200 mb-6 text-left max-w-2xl mx-auto">
                ...
                <div className="space-y-2">
                  ...
                  <p>
                    📢 Problem Statement Released: 12th April 2025 (Check them
                    Out in the Webisite)
                  </p>
                  <p>📅 Registration Closed: 12th April 2025 </p>
